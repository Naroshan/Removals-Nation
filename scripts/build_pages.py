...
.locs-hero h1{{font-family:'Syne',sans-serif;font-size:clamp(2rem,4vw,3rem);font-weight:800;letter-spacing:-.03em;margin-bottom:16px;color:var(--navy)}}
.locs-hero p{{color:var(--text-muted);font-size:1rem;line-height:1.7}}
.locs-count{{display:inline-block;background:rgba(244,88,10,.1);border:1px solid rgba(244,88,10,.25);border-radius:100px;padding:6px 18px;font-size:.82rem;font-weight:700;color:var(--navy);margin-bottom:24px}}
...
<div class="locs-hero">
  ...
  <p style="margin-top:14px">Moving in the capital? See our dedicated
     <a href="{root}removals-within-the-m25/index.html" style="color:var(--orange-cta)">removals within the M25</a>
